// Obtenga la entrada del usuario usando el aviso ("Ingrese la edad :"). Si el usuario tiene 18 años o más,
// muestre el mensaje: 'Tiene la edad suficiente para conducir', pero si no tiene 18 años, pon otro mensaje 
...
if (edad >= 18) {
  ...
  console.log('Te faltan '+añosEspera+' años para  poder conducir.');
}
...
if (myAge > yourAge) {
  ...
  console.log("Nuestra edad es la misma .");
}
...
// ● Septiembre, Octubre o Noviembre, la temporada  pertenece a Otoño.
// ● Diciembre, Enero o Febrero, la temporada pertenece a Invierno.
// ● Marzo, Abril o Mayo, la temporada pertenece Primavera.
// ● Junio, Julio o Agosto, la temporada pertenece a Verano.
...
let calificacion = parseFloat(prompt("Ingrese la puntuacion del estudiante a evaluar:"));
